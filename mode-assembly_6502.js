...
var Assembly6502HighlightRules = function() {
		...
		this.$rules = {
	        ...
	        "constbyte" : [
	            ...
	            {token : "constant.numeric", regex: "[b][01]{8}\\b", next : "comma3"},
	            {token : "constant.numeric", regex: "[b][01]{16}\\b", next : "comma3"},
	        ...
	        "identvalue" : [
	            ...
	            {token : "constant.numeric", regex: "#?[$][A-F0-9]{4}\\b", next : "start"},
	           	{token : "constant.numeric", regex: "#?[b][01]{8}\\b", next : "start"},
	            {token : "constant.numeric", regex: "#?[b][01]{16}\\b", next : "start"},
